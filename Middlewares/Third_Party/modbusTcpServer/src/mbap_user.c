...
//                           external variables
//****************************************************************************/
uint16_t g_sInputRegsBuf[MAX_INPUT_REGISTERS]                ;
uint16_t g_sHoldingRegsBuf[MAX_HOLDING_REGISTERS]          ;
uint8_t g_ucDiscreteInputsBuf[DISCRETE_INPUT_BUF_SIZE]      ;
uint8_t g_ucCoilsBuf[COILS_BUF_SIZE]                        ;

//****************************************************************************/
//                           Local variables
//****************************************************************************/
static uint16_t g_sHoldingRegsLowerLimitBuf[MAX_HOLDING_REGISTERS]  = {0};
static uint16_t g_sHoldingRegsHigherLimitBuf[MAX_HOLDING_REGISTERS] =
