...
{
    uint16_t                       *psHoldingRegisterLowerLimit;  //!<Pointer to Holding Register Lower Limits
    uint16_t                       *psHoldingRegisterHigherLimit; //!<Pointer to Holding Register Lower Limits
